...
const Portfolio = () => {
  return (
    <div className="bg-[#FAFAFA] h-screen w-screen scroll-py-10 overflow-x-hidden">
      <div className="absolute top-[5%] left-[50%] translate-x-[-50%]  text-[48px]">
          ...
          <div className="bg-[#005691] h-auto w-auto rounded-[24px] overflow-hidden">
            ...
            <div className="p-5 space-y-2">
              <h2 className="text-white text-[24px]">
                <a
                  href="https://template-login-bd.vercel.app/"
                  className="hover:font-colors:bg-cyan-400"
                >
                  Login Template
                </a>
              </h2>
